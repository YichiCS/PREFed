...
class Attack:
    ...
    def __init__(self, params, synthesizer):
        ...
        self.trigger_optimize = False
        self.trigger_init = False
    ...
    def compute_blind_loss(self, model, criterion, batch, attack, fixed_model=None, index=None):
        """
        :param model:
        :param criterion:
        :param batch:
        ...
        batch_back = self.synthesizer.make_backdoor_batch(batch, attack=attack, index=index)
        scale = dict()
